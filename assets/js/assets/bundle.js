...
async function makeGameScreen() {
  ...
  // If the user spends enough time in the load screen by the time they reach the game screen, the assets are completely loaded and the promise resolves instantly.
